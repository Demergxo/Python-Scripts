...
from PyQt6.QtWidgets import ( #type:ignore
    ...
    QHBoxLayout,  QCheckBox, QTableWidgetItem, QTableWidget, QErrorMessage
)
from PyQt6.QtCore import Qt, QLocale, QDate, QByteArray  #type:ignore
...
class VentanaConsultas(QtWidgets.QWidget):
    def __init__(self, fecha_inicio, fecha_fin, parent=None):
        ...
        self.btn_consulta3 = QPushButton("Fichero DBSchenker")
    ...
    def ejecutar_consulta2(self):
        ...
        try:
            qry_transport_XPO.consulta_XPO(self.fecha_inicio, self.fecha_fin)
    ...
    def ejecutar_consulta3(self):
        ...
        try:
            qry_transport_DBS.consulta_DBS(self.fecha_inicio, self.fecha_fin)
