...
def consulta_taisa(fecha_inicio, fecha_fin):
    ...
    query = text("""
        ...
        '' AS 'Agrupación carga / Matrícula', '' AS 'Hora de Carga',CampoCliente AS 'Tipo Doc', RTRIM(AlbaranDoc) AS 'AlbaranDoc', PedidoDestinatarioDoc AS 'Pedido Cliente',
        ...
        '' AS 'Dirección de entrega', ROUND(PesoFiege, 2) AS 'Peso Bruto', ROUND(BultosFiege, 0) AS 'Palés', '527' AS 'Estado', '' AS 'Peso Facturable (Real Taisa)',
